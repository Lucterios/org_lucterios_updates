...
//@DESC@Supprimer un module à mettre à jours
//@INDEX:module
...
$xfer_result->Caption='Supprimer un module à mettre à jours';
$xfer_result->m_context['ORIGINE']="ModulesToUpgrade_APAS_Del";
$xfer_result->m_context['TABLE_NAME']=$self->__table;
$xfer_result->m_context['RECORD_ID']=$self->id;
//@CODE_ACTION@
if($xfer_result->confirme("Etes vous sûre de vouloir supprimer ce module à mettre à jours?"))
	$self->delete();
//@CODE_ACTION@
