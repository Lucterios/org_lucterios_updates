...
// --- Last modification: Date 01 March 2008 15:24:36 By  ---
...
$xfer_result->Caption='Serveurs de mise à jours';
//@CODE_ACTION@
...
$lbl->setValue("{[center]}{[bold]}Liste des serveurs de mise à jours{[/bold]}{[/center]}");
$self->find();
