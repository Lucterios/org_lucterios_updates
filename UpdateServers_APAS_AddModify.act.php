...
// --- Last modification: Date 01 March 2008 15:25:41 By  ---
...
//@DESC@Ajouter/Modifier un serveur de mise à jours
//@PARAM@ 
//@INDEX:UpdateServers
...
$xfer_result->Caption='Ajouter/Modifier un serveur de mise à jours';
$xfer_result->m_context['ORIGINE']="UpdateServers_APAS_AddModify";
$xfer_result->m_context['TABLE_NAME']=$self->__table;
$xfer_result->m_context['RECORD_ID']=$self->id;
//@CODE_ACTION@
if ($self->id>0)
	$xfer_result->Caption="Modifier un serveur de mise à jours";
else
	$xfer_result->Caption="Ajouter un serveur de mise à jours";
