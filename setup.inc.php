...
$actions[3] = new Param_Action("Cycle d installation des mise a jour", "ModulesToUpgrade_APAS_Installation", 2);
...
$actions[7] = new Param_Action("Sélectionnez les mises à jour", "ModulesToUpgrade_APAS_SelectionUpgrade", 2);
